...
STATUS_MSG = "Executed. Affected row(s):{}"
...
# --------------------------#
gql_generator = gqlquery.GitHubSearchQuery(PAT, maxitems=20).generator()
i = 1
while True:
    try:
        ...
        print(
            "[{}] Reached end of query response. ETL done.".format(arrow.now())
        )
        break
